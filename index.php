    ...
    <section id="offres">
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-center">
                <a href="#" class="btn btn-primary rounded-pill mt-4">Voir les avantages</a>
            </div>
        </div>
    </section>
    <!-- END: Offres -->
                ...
                <div class="calendar-wrapper d-flex justify-content-around">
                    <div id="filter" class="col-12 col-sm-12 col-md-3 col-xl-3">
                        <div id="sejour" class="d-flex flex-column">
                            ...
                            <select name="hotel" id="hotel" class="form-select mb-3">
                                <option value="Disney Hotel Cheyenne ★★★">Disney Hotel Cheyenne ★★★</option>
                        ...
                        <div id="budget">
                            <div class="range">
                                ...
                                <div class="range-price d-none">
                                    ...
                                    <input type="number" name="min" id="min" value="0" hidden>
                                    <label for="max">Max</label>
                                    <input type="number" name="max" id="max" value="1000" hidden>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="calendar" class="col-12 col-sm-12 col-md-9 col-xl-9">
                        ...
                        <div id="estimation" class="d-none">
                            ...
                            <a href="#" id="next-calendar-btn" class="btn btn-primary rounded-pill d-flex align-items-center"><span>Continuer</span> <i class='bx bx-chevron-right'></i></a>
                        </div>
                        <div id="info_choice" class="d-none">
                            <h2 class="hotel_choice" id="hotel_value"></h2><!-- Vide car automatiquement rempli par du JS    -->
    ...
    <section id="acces-hygiene">
        ...
        <div class="container">
            <div class="hygiene-acces mt-3 mb-4">
                ...
                <div class="d-flex justify-content-center">
                    <a href="#" class="btn btn-primary rounded-pill">En savoir plus</a>
                </div>
            </div>
        </div>
    </section>
